...
copyright = u'2012-2022, Caktus Consulting Group'
...
version = '.'.join(scribbler.__version__.split('.')[0:2])
# The full version, including alpha/beta/rc tags.
release = scribbler.__version__
...
# documentation.
html_theme_options = {
    'tagline': "An application for managing snippets of text for a Django website.",
    'links': {
...
latex_documents = [
  ('index', 'django-scribbler.tex', u'django-scribbler Documentation',
   u'Mark Lavin', 'manual'),
]
...
man_pages = [
    ('index', 'django-scribbler', u'django-scribbler Documentation',
     [u'Mark Lavin'], 1)
]
...
texinfo_documents = [
  ('index', 'django-scribbler', u'django-scribbler Documentation',
   u'Mark Lavin', 'django-scribbler', 'One line description of project.',
   'Miscellaneous'),
]
